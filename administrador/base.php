    	...
    	<div class="row">
    		<div class="col s12">
    			<div class="card z-depth-5">
    				<div class="card-content">
    					<div class="center">
    						<a href="seguro.php?delete=0" class="waves-effect waves-light btn"><i class="material-icons left">delete_forever</i>Eliminar base de datos</a>
    						<br><br>
    						<a href="seguro.php?delete=1" class="waves-effect waves-light btn"><i class="material-icons left">delete</i>Eliminar base de datos(alumnos)</a>
    					</div>
    				</div>
    			</div>
    		</div>
